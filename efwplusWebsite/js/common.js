define(['jquery', "handlebars.min", 'jquery.cookie'], function ($, Handlebars) {
    var baseUrl = "/WebApi.aspx?controller=projectController&method=test&args=123";
    ...
    function webapiGet(controller, method, requestData, callback, errorback) {
        $.ajax({
            type: 'get',
            url: "/WebApi.aspx?controller=" + controller + "&method=" + method,
            data: requestData,
            crossDomain: true,
            success: function (retdata) {
                if (callback)
    ...
    function webapiPost(formId,controller, method, callback, errorback) {
    ...
    function postUrl(controller, method) {
        return "/WebApi.aspx?controller=" + controller + "&method=" + method;
    }
